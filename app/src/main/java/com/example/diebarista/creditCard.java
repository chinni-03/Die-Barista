...
public class creditCard extends Fragment {
    EditText cno, cname, ccvv, cexpiry;
    Button creditb;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cno=v.findViewById(R.id.CreditNo);
        cname=v.findViewById(R.id.CreditName);
        ccvv=v.findViewById(R.id.CreditCvv);
        cexpiry=v.findViewById(R.id.CreditExpiry);
        creditb=v.findViewById(R.id.Cb1);
